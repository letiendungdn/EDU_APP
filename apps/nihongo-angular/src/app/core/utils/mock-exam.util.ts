...
export function parseMockExamSession(data: Record<string, unknown>): MockExamSession {
  return data as unknown as MockExamSession;
}

export function parseMockExamResult(data: Record<string, unknown>): MockExamResult {
  return data as unknown as MockExamResult;
}
