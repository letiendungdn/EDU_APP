...
import { seedTextbooks } from './seed-textbooks';
import { seedTextbookCatalog } from './seed-textbook-catalog';
import { seedMindMaps } from './seed-mind-maps';
...
async function main() {
  ...
  await seedTextbooks(prisma);
  await seedTextbookCatalog(prisma);
