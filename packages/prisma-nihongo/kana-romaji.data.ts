/** Bảng tra kana → romaji (hiragana + katakana, gồm âm ghép 2 mora). */
export const KANA_ROMAJI_ENTRIES: ReadonlyArray<{ kana: string; romaji: string }> = [
  // âm ghép (ưu tiên match 2 ký tự)
  ...
  { kana: 'わ', romaji: 'wa' }, { kana: 'を', romaji: 'wo' }, { kana: 'ん', romaji: 'n' }, { kana: 'っ', romaji: 'tt' },
  ...
  { kana: 'ワ', romaji: 'wa' }, { kana: 'ヲ', romaji: 'wo' }, { kana: 'ン', romaji: 'n' }, { kana: 'ッ', romaji: 'tt' }, { kana: 'ー', romaji: '-' },
