export const CONTENT_PATTERNS = {
  ...
  UPDATE_KANJI_ENTRY: 'content.kanji-entries.update',
  DELETE_KANJI_ENTRY: 'content.kanji-entries.delete',
  CREATE_KANJI_VOCAB: 'content.kanji-vocab.create',
  UPDATE_KANJI_VOCAB: 'content.kanji-vocab.update',
  DELETE_KANJI_VOCAB: 'content.kanji-vocab.delete',
  REORDER_KANJI_VOCAB: 'content.kanji-vocab.reorder',
  ...
  GET_VOCAB_SUFFIXES: 'content.vocab-suffixes.findAll',
  CREATE_VOCAB_SUFFIX_GROUP: 'content.vocab-suffixes.createGroup',
  UPDATE_VOCAB_SUFFIX_GROUP: 'content.vocab-suffixes.updateGroup',
  DELETE_VOCAB_SUFFIX_GROUP: 'content.vocab-suffixes.deleteGroup',
  CREATE_VOCAB_SUFFIX_ITEM: 'content.vocab-suffixes.createItem',
  UPDATE_VOCAB_SUFFIX_ITEM: 'content.vocab-suffixes.updateItem',
  DELETE_VOCAB_SUFFIX_ITEM: 'content.vocab-suffixes.deleteItem',
  REORDER_VOCAB_SUFFIX_ITEMS: 'content.vocab-suffixes.reorderItems',
...
export const EXAM_PATTERNS = {
  ...
  LIST_QUESTIONS: 'exam.templates.questions.list',
  CREATE_QUESTION: 'exam.templates.questions.create',
  UPDATE_QUESTION: 'exam.templates.questions.update',
  DELETE_QUESTION: 'exam.templates.questions.delete',
  REORDER_QUESTIONS: 'exam.templates.questions.reorder',
