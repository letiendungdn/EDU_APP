export declare const CONTENT_PATTERNS: {
    ...
    readonly GET_REFERENCE_LIST: "content.reference.findAll";
    readonly GET_REFERENCE: "content.reference.findOne";
    readonly GET_READING_PASSAGES: "content.reading.findAll";
    readonly GET_READING_PASSAGE: "content.reading.findOne";
    readonly SUBMIT_READING: "content.reading.submit";
};
...
export declare const PROGRESS_PATTERNS: {
    ...
    readonly GET_ANALYTICS: "progress.analytics.get";
    readonly UPSERT_DAILY_NOTE: "progress.notes.upsert";
    readonly GET_DAILY_NOTES: "progress.notes.list";
    readonly UPSERT_DAILY_GOALS: "progress.goals.upsert";
    readonly GET_DAILY_GOALS: "progress.goals.list";
};
